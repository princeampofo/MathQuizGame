...
public class Level2 : MonoBehaviour
{
    ...
    public static int levelScore;                           //Set static variable to keep final score of this level
    ...
    public void Start()
    {
        ...
        YourScore = GameControls.CurrentScore;      //Set game score to the final score of level 1
    ...
    public void CorrectButtonpressed()
    {
        ...
        if (i == Totalques)                                          //If the questions have reached the total number of questions
        {
            ...
            {
                levelScore = YourScore;                             //Assign your score to the static variable level score
